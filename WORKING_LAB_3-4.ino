...
const int ci_Grip_Motor_Open = 220;         // Experiment to determine appropriate value
...
const int ci_Line_Tracker_Tolerance = 70;   // May need to adjust this
       ...
       /*************************************************************************************/
         ...
         if(followLine){
           ...
           if (( ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  !(ui_Middle_Line_Tracker_Data < (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  (ui_Right_Line_Tracker_Data < (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance))) 
           {
             ...
             ui_Left_Motor_Speed = 1580;
             ui_Right_Motor_Speed = 1590;
             turn = 0;
             started = true;
             allBlack = false;
           }
           //go straight (Light - Light - Light)
           if (( ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  (ui_Middle_Line_Tracker_Data < (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  (ui_Right_Line_Tracker_Data < (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance))) 
           {
             if (turn == 1){
           ...
           if (( ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  !(ui_Middle_Line_Tracker_Data < (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  !(ui_Right_Line_Tracker_Data < (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance))) 
           {
             ...
             //slowing down
             ui_Right_Motor_Speed = 1530;
             //ui_Right_Motor_Speed = 1420;
             turn = 1;
             allBlack = false;
           }
           //turn right (Light - Light - Dark) +70 -40
           if (( ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  (ui_Middle_Line_Tracker_Data < (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  !(ui_Right_Line_Tracker_Data < (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance))) 
           {
             //Serial.println("RIGHT");
             //speeding up
           ...
           //turn left (Dark - Dark - Light)
           if (!( ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  !(ui_Middle_Line_Tracker_Data < (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  (ui_Right_Line_Tracker_Data < (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance))) 
           {
             //Serial.println("LEFT");
             //slowing down
             ui_Left_Motor_Speed = 1520;
           ...
           //turn left (Dark - Light - Light) +70 -40
           if (!( ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  (ui_Middle_Line_Tracker_Data < (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) &&  (ui_Right_Line_Tracker_Data < (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance))) 
           {
             //Serial.println("LEFT");
             //slowing down
         ...
         //gets to pickup location and picks up the flag
         if(stage == 3 && allBlack){
